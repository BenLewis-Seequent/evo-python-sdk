...
class BaseObject:
    ...
    async def _create(
        ...
        object_dict = await cls._data_to_dict(data, evo_context.get_data_client())
...
class SingleDatasetObject(BaseSpatialObject):
    ...
    def _construct_from_object(cls, evo_context: EvoContext, obj: DownloadedObject) -> Self:
        ...
        return cls(evo_context, obj, adapter, evo_context.get_data_client())
...
class MultiDatasetObject(BaseSpatialObject):
    ...
    def _construct_from_object(cls, evo_context: EvoContext, obj: DownloadedObject) -> Self:
        ...
        return cls(evo_context, obj, adapters, evo_context.get_data_client())
