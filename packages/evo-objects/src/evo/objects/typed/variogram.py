...
class Variogram(ConstructableObject[VariogramData]):
    ...
    def _repr_html_(self) -> str:
        ...
        rows.append(("Sill:", f"{self.sill:.4g}"))
        rows.append(("Nugget:", f"{self.nugget:.4g}"))
        rows.append(("Rotation Fixed:", str(self.is_rotation_fixed)))
        ...
        html = opening_html + f'<table>{"".join(table_rows)}</table>'
